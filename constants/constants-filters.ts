...
export const INTERVENTION_MECHANISM_MULTICOMPONENT_OPTIONS = INTERVENTION_MULTICOMPONENT_OPTIONS
export const INTERVENTION_MEDIUM_MULTICOMPONENT_OPTIONS = INTERVENTION_MULTICOMPONENT_OPTIONS
