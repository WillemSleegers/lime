...
export const MECHANISM_BINARY_LEVELS: BinaryModeratorLevel[] = [
  { label: "Choice architecture", column: "has_mechanism_choice_architecture" },
  { label: "Information", column: "has_mechanism_info" },
  { label: "Norms", column: "has_mechanism_norms" },
  { label: "Goal pursuit", column: "has_mechanism_goal_pursuit" },
  { label: "Emotions", column: "has_mechanism_emotions" },
