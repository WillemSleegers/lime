...
export const countUniqueFilteredValues = <T extends object, K extends keyof T, F extends keyof T>(
  array: T[],
  targetProperty: K,
  filterProperty: F,
  filterValue: T[F]
...
export const countUniqueValuesByGroup = <T extends object, K extends keyof T, G extends keyof T>(
  array: T[],
  targetProperty: K,
  groupByProperty: G
): Map<T[G], number> => {
