  ...
  return (
    <main className="container max-w-3xl py-12">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
        <Link
          href="mailto:someone@example.com?subject=Study to add to the LIME project"
        ...
        <Link
          href="mailto:someone@example.com?subject=Question about the LIME project"
          className="flex flex-col items-center justify-between rounded-md border-2 border-primary bg-transparent p-4 hover:bg-accent hover:text-accent-foreground"
        >
          <MailQuestion />
          Question
        ...
        <Link
          href="mailto:someone@example.com?subject=Bug report for the LIME project"
          className="flex flex-col items-center justify-between rounded-md border-2 border-primary bg-transparent p-4 hover:bg-accent hover:text-accent-foreground"
        >
          <MailWarning />
          Bug
